...
public class FM {
public static void main( String args[] ) throws FilloException, InterruptedException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException, ClassNotFoundException {
	FM fm = new FM();
...
//fm.getClass().getMethod(kjf).invoke(fm, TestCase);
	UpdateTestcase("Credentials","E",TestCase);//updating test case as E
    Method setNameMethod = fm.getClass().getMethod(kjf, String.class);
    setNameMethod.invoke(kjf, TestCase); // pass arg
}
//webDriver.Dispose() ;
}
...
public static void TestCallingFunction(String TestCase) throws FilloException, InterruptedException {
	//String TestCase= FetchTestID( "Credentials");
	System.out.println("1st functio");
...
public static void TestCallingFunction1(String TestCase) throws FilloException, InterruptedException {
	System.out.println("2nd functio");
	System.out.println("Reached ");
	System.out.println(TestCase);
	//System.out.println("Testcase is"+TestCase);/// test case
	String Userid= FetchValue( "Credentials",TestCase,"Username");
